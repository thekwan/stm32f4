...
int main(void)
{
  ...
  //STM_EVAL_LEDInit(LED5);	// there is such LED5 and LED6 in KWAN B/D
  //STM_EVAL_LEDInit(LED6);
  
  STM_EVAL_LEDOn(LED3); /* Turn LED4 on: start of configuration */
  
  /* Configure and enable the DMA Stream for Memory to Memory transfer */
  DMA_Config();

  //STM_EVAL_LEDOn(LED4); /* Turn LED3 on: start of Transfer */
